...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Mobile nutrition tracking app for WSU students featuring Calorie Mama API meal recognition, Supabase PostgreSQL backend, and user authentication. Built as a full-stack developer in a team of 3.",
    longDescription:
      "Built as a full-stack developer in a team of 3, this app was designed specifically for Wichita State University students to simplify nutrition tracking. Designed and managed the app's Supabase Postgres database, creating schemas, tables, and relationships to support users, meals, and nutrition tracking. Implemented backend logic in JavaScript (Supabase edge functions / API calls) to handle user authentication, meal logging, and nutrition calculations. Integrated the Calorie Mama API to identify meals from photos, map them to nutrition entries, and suggest corrections for ambiguous inputs.",
    tags: ["JavaScript", "React Native", "Supabase", "PostgreSQL", "Calorie Mama API"],
